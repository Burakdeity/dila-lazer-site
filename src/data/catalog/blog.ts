...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: "Sakarya'da Neon LED Seçim Rehberi",
    excerpt: "Adapazarı ve Sakarya'da işletmeniz için doğru neon LED'yi nasıl seçersiniz?",
    cover: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800&q=80",
    category: "Sakarya",
    date: "10 Haziran 2025",
    author: "Editör",
    content: [
      "Sakarya'da neon yaptırmadan önce kullanım alanınızı netleştirin: iç mekan cafe, vitrin veya dış cephe uygulamaları farklı malzeme ve IP koruma sınıfı gerektirir.",
  ...
  },
  {
    ...
    title: "2025 Neon LED Seçim Rehberi",
    excerpt: "İşletmeniz için doğru neon LED'yi nasıl seçersiniz?",
    cover: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800&q=80",
    category: "Rehber",
    date: "15 Mayıs 2025",
    author: "Editör",
    content: [
      "Neon seçerken önce kullanım alanını belirleyin: iç mekan, vitrin veya dış cephe. Her ortam için farklı IP koruma sınıfı ve malzeme gerekir.",
